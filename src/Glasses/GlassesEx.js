  ...
  renderInfo = (glasses) => {
    return (
      <div>
        ...
        <p style={{ color: "red", frontWeight: "700" }}>
          <strong style={{ color: "red", frontWeight: "700" }}>Name:</strong>{" "}
          {glasses.name}
        </p>
        <p style={{ color: "red", frontWeight: "700" }}>
          <strong style={{ color: "red", frontWeight: "700" }}>Price:</strong> $
          {glasses.price}
        </p>
      </div>
    );
